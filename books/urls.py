...
web_urlpatterns = [
    ...
    path('preview/<slug:slug>', views.preview_pdf, name='preview'),
    path('payment-method/<slug:slug>/', views.payment_method, name='payment-method'),
    ...
    # path('login-product-details/<slug:slug>/', views.login_product_details, name='login-product-details'),
...
auth_patterns = [
    ...
    path("api/books/<slug:slug>/preview/", book_details_api, name="book-preview"),
]
