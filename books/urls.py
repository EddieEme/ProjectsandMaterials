...
web_urlpatterns = [
    ...
    path('departments/<int:department_id>/', views.department, name='departments'),
    path('login-departments/<int:department_id>/', views.login_department, name='login-departments'),
